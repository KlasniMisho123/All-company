...
export default function responseStep(props:StepProps) {
  ...
  return (
        <div className={`flex flex-col sm:flex-row w-full gap-4 p-4 rounded-xl bg-gray-50 hover:bg-gray-200 transition-all duration-300 border-l-4 ${selectedColor.borderBase} hover:-translate-y-1`}>
            <div className={`flex-shrink-0 p-4 rounded-lg ${selectedColor.bgLight} flex items-center justify-center`}>
                <span className={`${selectedColor.text} text-xl`}>
