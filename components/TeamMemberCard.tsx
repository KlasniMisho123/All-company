...
export default function TeamMemberCard(props:TeamMemberInfo) {
  ...
  return (
    <div className="relative flex-1 rounded-2xl bg-slate-800 w-max h-[300px] max-w-[250px] overflow-hidden shadow-lg group">
        ...
        <div className='relatuve absolute inset-0 bg-slate-800/50 h-[25%] transition-all duration-700 self-end group-hover:h-full '>
            ...
            <div className="absolute inset-0 group-hover:h-full transition-all duration-600 bg-center bg-fit z-0 opacity-30 "
                style={{ backgroundImage: "url(/bg-red-grid.jpg)" }}>
